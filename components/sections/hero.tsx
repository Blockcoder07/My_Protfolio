...
export function Hero() {
  return (
    <section
      id="home"
      className="relative isolate flex min-h-screen items-center overflow-hidden pb-16 pt-32 sm:pt-36"
    >
      {/* Background layers */}
      ...
      <div className="container relative mx-auto grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
        <motion.div
        ...
        >
          ...
          >
            ...
            <span className="block pt-3 text-2xl font-semibold text-muted-foreground sm:text-3xl md:text-4xl">
              I build{" "}
              <TypingEffect
                words={[
                  "Full Stack .NET apps",
          ...
          >
            ...
            products — backed by 2.5 years of hands-on engineering across
            ASP.NET Core, Web API, SQL Server, and Azure DevOps.
          </motion.p>
          ...
          <motion.div
            ...
            className="mt-10 grid max-w-lg grid-cols-3 gap-3 sm:gap-6"
          >
            {[
        ...
        >
          <div className="relative h-[320px] w-[320px] sm:h-[400px] sm:w-[400px] lg:h-[460px] lg:w-[460px]">
            ...
            <motion.div
              ...
              className="glass-card absolute -left-2 top-10 hidden items-center gap-2 rounded-full px-3 py-2 text-xs font-medium sm:flex"
            >
            ...
            <motion.div
              ...
              className="glass-card absolute -right-2 top-1/3 hidden items-center gap-2 rounded-full px-3 py-2 text-xs font-medium sm:flex"
            >
            ...
            <motion.div
              ...
              className="glass-card absolute -left-4 bottom-12 hidden items-center gap-2 rounded-full px-3 py-2 text-xs font-medium sm:flex"
            >
            ...
            <motion.div
              ...
              className="glass-card absolute -right-4 bottom-20 hidden items-center gap-2 rounded-full px-3 py-2 text-xs font-medium sm:flex"
            >
